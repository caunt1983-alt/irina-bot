...
async def generate_message() -> str:
    ...
    hour = now.hour
    time_hint = {
        8:  "первое утреннее — ОБЯЗАТЕЛЬНО начни с приветствия (Доброе утро! / С добрым утром! и т.п.), бодрое, про хороший старт дня",
        ...
        20: "последнее вечернее — про отдых и тепло, ОБЯЗАТЕЛЬНО заверши прощанием (Спокойной ночи! / До завтра! / Сладких снов! и т.п.)",
    }
